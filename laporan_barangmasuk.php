  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <form action="export.php" method="post">
        ...
        <div class="mb-3">
          <a href="export.php" class="btn btn-primary custom-btn">
        ...
        <div class="table-responsive">
          <table class="table table-bordered" id="barangmasuk" width="100%" cellspacing="0">
            ...
            <tbody>
              ...
              $sql = $koneksi->query("SELECT * FROM barang_masuk ORDER BY tanggal DESC, id_transaksi ASC");
              ...
              while ($data = $sql->fetch_assoc()) {
                ...
                <tr>
                  ...
                  <td style="text-align: center;"><?php echo $tanggalMasuk; ?></td> <!-- Display Tanggal Masuk -->
                  ...
                  <td style="text-align: center;"><?php echo $data['jumlah']; ?></td> <!-- Display Jumlah Masuk -->
                  <td style="text-align: center;"><?php echo $data['satuan']; ?></td> <!-- Display Satuan -->
                  <td style="text-align: center;">
                    <!-- Export to PDF -->
                    <a href="export_laporan_barangmasuk_pdf.php?id=<?php echo $data['id_transaksi']; ?>"
...
<script>
  $(document).ready(function () {
    var table = $('#barangmasuk').DataTable({
      ...
      order: [[2, 'desc']] // Urutkan berdasarkan tanggal (Tanggal Masuk)
    });
    ...
    $.fn.dataTable.ext.search.push(
      function (settings, data, dataIndex) {
        var min = $('#min').val();
        var max = $('#max').val();
        var date = data[2]; // column index 2 (Tanggal Masuk)
