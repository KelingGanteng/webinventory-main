...
if (isset($_GET['id'])) {
    ...
    // Ambil data barang keluar berdasarkan ID transaksi
    $sql = $koneksi->query("SELECT barang_keluar.*, 
                                   gudang.satuan, 
                            ...
                            WHERE barang_keluar.id_transaksi = '$id_transaksi'");
    $dataBarangKeluar = $sql->fetch_assoc(); // Ambil satu data saja
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="section-content">
                ...
                <div><strong>ID Transaksi:</strong> {$dataBarangKeluar['id_transaksi']}</div>
                <div><strong>Tanggal Keluar:</strong> {$dataBarangKeluar['tanggal']}</div>
                <div><strong>Kode Barang:</strong> {$dataBarangKeluar['kode_barang']}</div>
                <div><strong>Nama Barang:</strong> {$dataBarangKeluar['nama_barang']}</div>
                <div><strong>Kondisi:</strong> {$dataBarangKeluar['kondisi']}</div>
                <div><strong>Jumlah Keluar:</strong> {$dataBarangKeluar['jumlah']}</div>
                <div><strong>Satuan:</strong> {$dataBarangKeluar['satuan']}</div>
                <div><strong>Nama Karyawan:</strong> {$dataBarangKeluar['nama_karyawan']}</div>
                <div><strong>Departemen:</strong> {$dataBarangKeluar['nama_departemen']}</div>
            </div>
